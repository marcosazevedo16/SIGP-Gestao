...
function renderMunicipalities() {
    ...
    if (filtered.length === 0) {
        ...
        c.innerHTML = `<table><thead><th>Município</th><th>Módulos Em Uso</th><th>Gestor(a) Atual</th><th>Contato</th><th>Data Implantação</th><th>Última Visita Presencial</th><th>Tempo de Uso</th><th>Dias sem Visita</th><th>Status</th><th>Bloqueio/Parou de Usar</th><th>Ações</th></thead><tbody>${rows}</tbody></table>`;
    }
